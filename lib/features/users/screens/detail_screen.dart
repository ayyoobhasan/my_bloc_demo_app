...
class _UserDetailScreenState extends State<UserDetailScreen> {
  ...
  void initState() {
    ...
    addressController = TextEditingController(text: widget.user.address?.street ?? "address");


    final userBloc = context.read<UserDetailBloc>();
    userBloc.add(FetchUserDetail(widget.user.id));
  }
